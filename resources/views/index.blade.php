  ...
  <section id="hero">
    ...
    >
      ...
      >
        ...
        <div
          class="carousel-item"
          style="background-image: url('{{ asset('front/img/slide/slide-2.jpg') }}')"
        >
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
        ...
        <div
          class="carousel-item"
          style="background-image: url('{{ asset('front/img/slide/slide-3.jpg') }}')"
        >
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
        ...
        >
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              ...
              <p>App</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-1.jpg') }}"
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              ...
              <p>Web</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-2.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="Web 3"
              ><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              ...
              <p>App</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-3.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="App 2"
              ><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              ...
              <p>Card</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-4.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="Card 2"
              ><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              ...
              <p>Web</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-5.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="Web 2"
              ><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              ...
              <p>App</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-6.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="App 3"
              ><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              ...
              <p>Card</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-7.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="Card 1"
              ><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              ...
              <p>Card</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-8.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="Card 3"
              ><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              ...
              <p>Web</p>
              <a
                href="{{ asset('front/img/portfolio/portfolio-9.jpg') }}"
                data-gall="portfolioGallery"
                class="venobox preview-link"
                title="Web 3"
              ><i class="bx bx-plus"></i></a>
